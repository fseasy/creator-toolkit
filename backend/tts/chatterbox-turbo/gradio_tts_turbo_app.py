...
def load_model():
    ...
    _m = ChatterboxTurboTTS.from_local("./model", DEVICE)
    return _m
...
def generate(
    ...
    # if model.conds is None and audio_prompt_path is not None:
    #     model.prepare_conditionals(wav_fpath=audio_prompt_path, exaggeration=0.0, norm_loudness=norm_loudness)
